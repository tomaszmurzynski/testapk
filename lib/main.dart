...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'I Igrzyska Europejskie w Esport',
      // wyłączenie modułu dema w narożniku
...
class _VerticalPagesState extends State<VerticalPages> {
  final List<String> titles = [
    ...
    "I Igrzyska Europejskie w Esporcie",
    "Studencki symulator igrzysk",
    "Studenckie Igrzyska Cyberbezpieczeństwa"
  ];
